...
@interface AAPLGeneric(AAPLBasicDataSource, ItemType) : AAPLGeneric(AAPLDataSource, ItemType)
 ...
 */
@property (nonatomic, copy) AAPLGeneric(NSArray, ItemType) *items;
 ...
 */
- (void)setItems:(AAPLGeneric(NSArray, ItemType) *)items animated:(BOOL)animated;
