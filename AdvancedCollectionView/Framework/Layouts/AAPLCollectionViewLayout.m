...
@property (nonatomic, strong) AAPLKindOf(UIView *) collectionViewWrapper;
#endif
...
- (void)createLayoutInfoFromDataSource
{
    ...
    UICollectionView *collectionView = self.collectionView;
    AAPLGeneric(NSDictionary, NSNumber *, AAPLDataSourceSectionMetrics *) *layoutMetrics = [self snapshotMetrics];
